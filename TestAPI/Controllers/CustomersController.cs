...
namespace TestAPI.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        // GET: customers/syncnotracking
        [HttpGet("syncnotracking")]
        public CustomerInfoModel GetCustomersNoTracking()
        {
            var model = new CustomerInfoModel();
            var customers = new List<CustomerModel>();

            // dumb queries to excercise the DB
            model.Total = _context.Customers.AsNoTracking().Count(c => c.CustomerID != 0);
            var salesOrderTotal = _context.SalesOrders.AsNoTracking().Count(c => c.Customer.CustomerID == 29485);
